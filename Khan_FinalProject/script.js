...
function info() {
    fHeight = screen.height - screen.availHeight;
    document.getElementsByTagName("p1")[0].innerHTML = "Your Web broweser is " + navigator.appName;
    document.getElementsByTagName("p1")[1].innerHTML = "Your Web Browser Version is " + navigator.appVersion;
    document.getElementsByTagName("p1")[2].innerHTML ="Your GeoLocation is " + navigator.geolocation;
    document.getElementsByTagName("p1")[3].innerHTML ="Your Operating Platform is " + navigator.platform;
    document.getElementsByTagName("p1")[4].innerHTML = "Your screens height is " + screen.height;
    document.getElementsByTagName("p1")[5].innerHTML = "Your browser takes up " + fHeight + " of your total screen";
}